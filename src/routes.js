...
const routes = [
  ...
  { path: "/car", exact: true, name: "จัดการรถ" , component: Car},
  ...
  { path: '/floor2', name: 'Floor2', component: Floor2 },
  { path: '/floor3', name: 'Floor3', component: Floor3 },
  { path: '/floor4', name: 'Floor4', component: Floor4 },
