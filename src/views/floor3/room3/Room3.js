...
import Modal3301 from "../room3/Modal3301";
import Modal3302 from "../room3/Modal3302";
import Modal3303 from "../room3/Modal3303";
import Modal3304 from "../room3/Modal3304";
import Modal3305 from "../room3/Modal3305";
import Modal3306 from "../room3/Modal3306";
import Modal3307 from "../room3/Modal3307";
import Modal3308 from "../room3/Modal3308";
...
class Roomtest1 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3301")
      .then(res => {
...
class Roomtest2 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3302")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest3 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3303")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest4 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3304")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest5 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3305")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest6 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3306")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest7 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3307")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest8 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=3&room=3&bednumber=3308")
      .then(res => {
          console.log(res.data.data)
