...
class Roomtest1 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4801")
      .then(res => {
...
class Roomtest2 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4802")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest3 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4803")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest4 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4804")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest5 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4805")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest6 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4806")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest7 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4807")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest8 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=8&bednumber=4808")
      .then(res => {
          console.log(res.data.data)
