...
class Roomtest1 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4401")
      .then(res => {
...
class Roomtest2 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4402")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest3 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4403")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest4 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4404")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest5 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4405")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest6 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4406")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest7 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4407")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest8 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=4&bednumber=4408")
      .then(res => {
          console.log(res.data.data)
