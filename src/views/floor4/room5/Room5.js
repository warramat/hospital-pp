...
import Modal4501 from "../room5/Modal4501";
import Modal4502 from "../room5/Modal4502";
import Modal4503 from "../room5/Modal4503";
import Modal4504 from "../room5/Modal4504";
import Modal4505 from "../room5/Modal4505";
import Modal4506 from "../room5/Modal4506";
import Modal4507 from "../room5/Modal4507";
import Modal4508 from "../room5/Modal4508";
...
class Roomtest1 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4501")
      .then(res => {
...
class Roomtest2 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4502")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest3 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4503")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest4 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4504")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest5 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4505")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest6 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4506")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest7 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4507")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest8 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=5&bednumber=4508")
      .then(res => {
          console.log(res.data.data)
