...
class Roomtest1 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4101")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest2 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4102")
      .then(res => {
          console.log(res.data.data)
          ...
          console.log("room2",this.state.room1[0])
      })
      .catch(err => { 
          console.log(err)})
  }
...
class Roomtest3 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4103")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest4 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4104")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest5 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4105")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest6 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4106")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest7 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4107")
      .then(res => {
          console.log(res.data.data)
...
class Roomtest8 extends Component {
  ...
  handleTestRoom1(){
      axios.get("https://hotpital-pakpoon.herokuapp.com/auth/pagination/?page=1&limit=50&floor=4&room=1&bednumber=4108")
      .then(res => {
          console.log(res.data.data)
